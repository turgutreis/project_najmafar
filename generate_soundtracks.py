...
def main():
    ...
    print("==========================================================", flush=True)
    print("  🌌 NAJMAFAR: HIGH-FIDELITY QUANTUM SOUNDTRACK ENGINE  ", flush=True)
    print("==========================================================", flush=True)
    ...
    for trk in tracks:
        ...
        out_path = os.path.join(args.outdir, trk["file"])
        save_wav(out_path, pcm_data, sample_rate=44100)

    print("\n✨ Alle 3 Soundtracks wurden mit eigenständigem Charakter und ohne Rauschen gerendert!", flush=True)
